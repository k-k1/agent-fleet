...
Codex CLI, OpenCode, GitHub Copilot CLI, Antigravity CLI) as a managed fleet: each member gets an
...
Release engineering design and gates: docs/35 (packaging). Deployment architecture
