...
exec env \
  ...
  ${AF_BRAND_COLOR:+AF_BRAND_COLOR="$AF_BRAND_COLOR"} \
  ${AF_BRAND_LABEL:+AF_BRAND_LABEL="$AF_BRAND_LABEL"} \
  ${AF_ENGINE_CIVITAI_RED:+AF_ENGINE_CIVITAI_RED="$AF_ENGINE_CIVITAI_RED"} \
  /tmp/af-cp
