...
| The S3 bucket as the ledger of what is actually held | deployment admin (super_admin) | Admin → Inference engine models → S3 Bucket | [admin 04](../admin/04-mcp-egress.md) |
