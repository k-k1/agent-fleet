...
unauthenticated session would accept work and then fail every turn. These same preconditions
gate the assistant chat: if neither is satisfied, muse does not appear as a backend option.
