...
- **リポジトリで開発する** — 「開発のセットアップへ」で続きの手順が展開されます。
  1. **git プロバイダを接続**（任意）— GitHub／Bitbucketにサインイン。privateリポジトリをクローン／pushするなら必要です（[04 リポジトリと git](03-code.ja.md)）。
...
[04 リポジトリと git](03-code.ja.md) にまとめています。
...
クローンに失敗するなど）は [09 困ったとき](11-troubleshooting.ja.md) にまとめてあります。

---

仕組みを知りたい人へ: [dev/01 全体アーキテクチャ](../build/01-architecture.ja.md)
