...
ワークスペース設定の **ツールチェーン** タブの **データベース** カードで、各エンジンの状態
（バージョン・常駐サイズ (MB)・ポート・接続 URL）を確認したり、端末を開かずに
Start / Stop / Reset を操作できます。
