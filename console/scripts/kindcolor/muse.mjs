...
// `sem:err` is --err. When this sweep was first run --err was declared nowhere and #f85149 was a
// literal in both themes (the lcpp round found this); the light value now follows tokens.css.
const DARK = {
...
const LIGHT = {
  ...
  'sem:err': '#b42318', 'sem:ok': '#146c2e', 'sem:warn': '#8a5b00', 'sem:accent': '#1d4ed8',
};
