// Sparkline — tiny inline trend chart (SVG); WsBar tiles + the chat spend trend. `data`
...
export function Sparkline({ data, max, track = false, width = 28, height = 14 }: SparklineProps) {
