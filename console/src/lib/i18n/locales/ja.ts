...
export const ja = {
  ...
  "keys.kt.quickRepliesNote":
    "オンにすると、コンポーサーの上によく使う短い返信（OK・進めて・commit など）と直近の回答に沿った候補をチップで表示します。クリックで入力欄に差し込み、Ctrl・⌘・Alt のいずれかを押しながらクリックで即送信。候補はあなたが送った短文から学習します。既定はオン。",
  ...
  // コンポーザ
  "mirror.suggest_hint": "クリックで入力欄へ・Ctrl/⌘/Alt＋クリックで即送信",
