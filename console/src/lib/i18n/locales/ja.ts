...
export const ja = {
  ...
  "agents.agy_usage_title": "クォータ残量",
  "agents.agy_usage_weekly": "週次",
  "agents.agy_usage_5h": "5時間枠",
  "agents.agy_usage_remaining": "{pct}% 残",
  "agents.agy_usage_resets": "リセット: {when}",
  "agents.agy_usage_loading": "残量を取得中…（agy を起動しています）",
  "agents.agy_usage_unavailable": "残量を取得できませんでした",
  "agents.agy_usage_refresh": "残量を更新",
