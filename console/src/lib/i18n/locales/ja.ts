...
export const ja = {
  ...
  // コンポーザ
  "mirror.suggest_hint":
    "クリックで入力欄へ・Ctrl/⌘/Alt＋クリックで即送信（入力欄が空なら Tab で候補へ・←/→ で候補選択／右クリック・長タップでピン留めと削除）",
  ...
  "ui.claude_full_model": "Claude の完全モデル ID",
  "ui.claude_full_model_placeholder": "完全モデル ID（例: claude-opus-4-8）",
  "ui.claude_full_model_hint": "旧版を固定する場合は完全モデル ID を入力。利用可否は Claude Code が起動時に確認します。",
