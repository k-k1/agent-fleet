...
export const ja = {
  ...
  "wi.bb_desc_reviewing": "自分がレビュアーになっている PR（選んだリポジトリの中）。",
  "wi.bb_desc_repo_open": "選んだリポジトリの open な PR すべて。",
  "wi.bb_desc_authored": "自分が作った PR（ワークスペース全体）。Bitbucket に横断検索が無いため、ワークスペース単位で出せるのはこれだけです。",
