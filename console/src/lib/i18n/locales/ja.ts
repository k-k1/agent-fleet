...
export const ja = {
  ...
  "pmcp.copy_from_cell": "{file} の \"{server}\" を他のファイルへコピー",
  "pmcp.copy_title": "\"{server}\"（{file}）を他のファイルへコピー",
  "pmcp.copy_to": "コピー先",
  "pmcp.copy_as": "名前",
  "pmcp.on_conflict": "同名の既存エントリがあります",
  "pmcp.on_conflict_overwrite": "上書き",
  "pmcp.on_conflict_skip": "スキップ",
  "pmcp.on_conflict_rename": "別名で追加",
  "pmcp.dialect_label": "プレースホルダの方言",
  "pmcp.dialect_translate": "方言を変換して書く（推奨）",
  "pmcp.dialect_as_is": "そのまま書く",
  "pmcp.dialect_expand": "実値へ展開して書く（非推奨）",
  "pmcp.dialect_none_hint": "{kind} はプレースホルダを展開しません。変換先を選べません。",
  "pmcp.with_secrets": "値",
  "pmcp.with_secrets_label": "値もコピーする（既定はキー名のみ）",
  "pmcp.with_secrets_warn": "コピー元とコピー先の Git 管理状態によっては、値が新たにコミット対象になる場合があります。",
  "pmcp.preview_title": "プレビュー（値はマスク）",
  "pmcp.preview_action": "プレビュー",
  "pmcp.apply_action": "適用",
  "pmcp.applied": "{file} に書き込みました",
  "pmcp.view_in_scm": "変更を見る",
  "pmcp.plan_stale": "このファイルは別の場所で変更されました。もう一度プレビューしてください。",
  "pmcp.op_skipped_toast": "既存のエントリがあるためスキップしました",
