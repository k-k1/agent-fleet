...
export const ja = {
  ...
  "clean.confirm_body": "削除するセッション・ブランチは復元用に退避されます。worktree の削除は取り消せません（未コミット/未pushは保護されます）。",
  "clean.confirm_do": "{count} 件を片付ける",
  "clean.run_done": "{done} 件を片付けました。{failed} 件は失敗しました。",
  "clean.run_done_ok": "{done} 件を片付けました。",
  "clean.archives_empty": "退避（復元用アーカイブ）はありません。",
  ...
  "pj.archive_stopped": "停止中をまとめてアーカイブ（shell/ssm は削除）",
