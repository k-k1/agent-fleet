...
export const ja = {
  ...
  "assistant.note_models":
    "ビルトインアシスタントが新しい会話で使うモデルです。優先順位で別の CLI に切り替わった場合も、その CLI の行で選んだモデルを使います。「既定」は CLI 側のモデル選択に任せます。",
  "assistant.utility_models": "タイトル・サジェストのモデル",
  "assistant.note_utility_models":
    "セッション／チャットのタイトル、ブランチ名、AI返信候補に使う短時間モデルです。CLIの選択は上の優先順位に従います。「既定」は CLI 側の既定または互換性を優先した自動選択です。",
