...
export const tools = {
  ...
  "env.db_title": "データベース",
  "env.db_intro":
    "このワークスペースの PostgreSQL と MySQL です。Agent が動かします。データはホームに置かれ、停止→起動をまたいで残ります。消えるのは「停止してデータも削除」とデータベースの削除だけです。",
  "env.db_ws_stopped": "ワークスペースを起動するとデータベースを管理できます。",
  "env.db_state_absent": "未インストール",
  "env.db_state_installing": "導入中…",
  "env.db_state_starting": "起動中…",
  "env.db_state_running": "稼働中",
  "env.db_state_stopped": "停止中",
  "env.db_state_error": "エラー",
  "env.db_rss": "{n} MB",
  "env.db_port": "ポート {n}",
  "env.db_none_yet": "データベースはまだありません。下で作成するか、作業コピーで `af-db url` を実行すると、そのコピー用のデータベースがここに並びます。",
  ...
  "env.db_autostart": "ワークスペース起動時に開始",
  "env.db_connect": "接続",
  ...
  "env.db_name_rule": "英小文字・数字・_ が使えます。先頭に数字は置けません。63 文字まで。",
  "env.db_name_taken": "このエンジンには同じ名前のデータベースがすでにあります。",
  "env.db_drop": "削除",
  "env.db_drop_confirm_title": "データベースを削除しますか？",
  "env.db_drop_confirm_body": "{db} と、その中のデータがすべて削除されます。接続が残っていても切断されます。取り消せません。",
  "env.db_drop_go": "削除する",
  "env.db_reset": "リセット",
  ...
  "machine.disk_part_pasted": "貼り付け・添付",
  "machine.disk_part_codex_view_image": "codex の画像",
  "machine.disk_part_memo_images": "メモの画像",
  "machine.disk_part_other": "その他",
  "machine.disk_orphans": "うち削除済みの分",
