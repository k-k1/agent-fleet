...
export const settings = {
  ...
  "agents.note_peer_messaging":
    "同じワークスペースの他セッションへ短いメッセージを送れるようにします。停止中のセッションには再開して届き、受け取った側はこれを利用者の指示とはみなしません。反映は次に起動するセッションから。既定 OFF。",
  "agents.fleet_observe": "セッションからのフリート観測",
  "agents.note_fleet_observe":
    "セッションが、他セッションの状態・自分のコンテキスト使用量・メモキューを見られるようにします。他セッションへの指示など、操作できることは増えません。反映は次に起動するセッションから。既定 OFF。",
