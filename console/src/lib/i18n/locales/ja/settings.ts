...
export const settings = {
  ...
  "agents.note_fleet_spawn":
    "セッションが、別のセッションを起こして仕事を渡し、自分が起こした子だけを世話（一覧・出力の確認・停止・再開）できるようにします。指示・回答・削除はどのセッションにもできません。子は 1 セッションあたり 3 本まで（枠は削除・アーカイブで空きます）、孫と生シェルは起こせません。子 1 本がエージェント 1 つ分のメモリと利用枠を使い、消費はあなたの請求に載ります。反映は次に起動するセッションから。既定 OFF。",
