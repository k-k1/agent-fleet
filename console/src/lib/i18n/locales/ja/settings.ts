...
export const settings = {
  ...
  "agents.note_fleet_spawn":
    "セッションが、別のセッションを起こして仕事を渡し、自分が起こしたものだけを世話（出力の確認・停止・再開）できるようにします。指示・回答・削除はどのセッションにもできません（自分の子であっても）。子は 1 セッションあたり 3 本まで（停止では枠は空かず、削除で空きます）、孫は起こせず、生シェルも起こせず、子は必ず自分の worktree で始まります。**子 1 本はこのワークスペースのメモリを丸ごと 1 エージェント分使い、消費はあなたの請求に載ります。** 反映は次に起動するセッションから。既定 OFF。",
