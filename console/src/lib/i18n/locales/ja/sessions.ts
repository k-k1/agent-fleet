...
export const sessions = {
  ...
  "agent.launch_hint.muse": "Muse Code を起動",
  ...
  "wsbar.machine_details": "マシンと使用状況",
  ...
  "sess.stop_after_turn_on": "このターンが終わったら停止します",
  "sess.stop_after_turn_off": "ターン終了後の停止を取り消しました",
  ...
  "sess.delete_body": "「{name}」をごみ箱へ移します。掃除のごみ箱から復元できます。",
  "sess.cleanup_archive_n": "{count} 件をアーカイブ",
  "sess.cleanup_delete_n": "shell/ssm {count} 件をごみ箱へ",
  ...
  "sess.tidy_orphans_trash": "shell/ssm はごみ箱へ移り、掃除のごみ箱から戻せます。",
  ...
  "srow.stop_after_turn_on": "ターン終了後に停止する",
  "srow.stop_after_turn_off": "ターン終了後の停止をやめる",
  ...
  "srow.studio_badge": "画像生成スタジオに結ばれています（開くとスタジオへ）",
  ...
  "ovw.group_count": "稼働 {alive} / 全 {n}",
  "ovw.waiting_for": "待ち {d}",
