...
export const mirror = {
  ...
  "mirror.hsearch_label": "入力履歴を検索",
  "mirror.hsearch_failed": "一致なし",
  "mirror.hsearch_ph": "過去に送った文を検索（Ctrl+R）",
  "mirror.hsearch_hint": "Ctrl+R 前へ・Ctrl+S 後へ・Enter で入力欄へ（送信なし）・Esc 取り消し",
  "mirror.hsearch_cancel": "検索をやめて元の入力に戻す",
  "mirror.hsearch_open": "入力履歴を検索（Ctrl+R）",
