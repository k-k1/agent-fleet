...
export const admin = {
  ...
  // --- 外部管理のエンジン（ADR 0076）---
  // 🔴 TTS の「常駐 docker 等」は流用しない。VOICEVOX はそれで合っているが、LAN の
  // ComfyUI は誰かの PC で動いていることもある。両者に共通する主張は「この配備は
  // 起動も停止も持たない」で、運用者が読むべきなのもそれだけである。
  ...
  "admin.catalog_parts_fix_moving": "この行の本体をバケツの中で移しています（ダウンロードはありません）。完了するとこの行が読めるようになります。",
  // 本体を持っているのに「不足」と出る唯一の理由を、行の上で言う。
  "admin.catalog_main_file_misplaced": "この行の本体は「チェックポイント（単一ファイル）」として登録されていますが、この族のワークフローはその役割を読みません。バイト列は {from} にあり、ローダーが一覧するのは {to} です——「不足ファイルを揃える」でバケツの中を移し、{f} として付け直します。",
  ...
  "admin.catalog_parts": "ファイルと部品",
  "admin.catalog_parts_unknown": "このモデルにはファイルキーが記録されていません。",
  "admin.catalog_manual_s3": "既存の S3 ファイルを登録",
  ...
  "admin.catalog_attach": "部品を追加",
  "admin.catalog_replace": "置き換え",
  "admin.catalog_operation_title": "モデルファイルを追加",
  "admin.catalog_act_new": "新しいモデル",
  "admin.catalog_act_attach": "部品を追加",
  "admin.catalog_act_replace": "部品を置き換え",
  ...
  "admin.catalog_destination": "追加先",
  "admin.catalog_pick_target": "登録済みモデルを選ぶ",
  "admin.catalog_pick_part": "ファイルの役割を選ぶ",
  "admin.catalog_size_unknown": "サイズ未取得",
  "admin.catalog_reuse_present": "保存済みファイルを再利用します",
  "admin.catalog_with_vae": "このチェックポイントに必要なファミリー VAE も追加する",
  "admin.catalog_vram_warning": "ファイルだけで約 {need} MiB、選択中のカードは {card} MiB です。承知して続けます。",
  "admin.catalog_vram_warning_llm": "このコンテキストでは重みと KV キャッシュで約 {need} MiB、選択中のカードは {card} MiB です。承知して続けます。",
  ...
  "admin.catalog_resolving": "選択したファイルを確認しています…",
  "admin.catalog_need_target": "変更する登録済みモデルを選んでください。",
  "admin.catalog_need_part": "変更するファイルの役割を選んでください。",
  "admin.catalog_need_license": "配布元のライセンスを読み、同意してください。",
  "admin.catalog_need_vram": "VRAM の注意を確認してください。",
