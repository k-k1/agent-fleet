...
export const admin = {
  ...
  "clean.reason.cache_no_store": "セッションの保存先が見つからないので、セッションのフォルダは判定しない（チャットの分だけが対象。保存先が戻れば点検できる）",
  ...
  "clean.reason_hint.cache_no_store": "セッションの保存先が見つからないため、セッションのフォルダは判定しません。チャットの分だけが対象です",
