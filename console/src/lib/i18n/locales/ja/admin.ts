...
export const admin = {
  ...
  "admin.engines_idle_label": "自動停止まで",
  "admin.engines_idle_minutes": "分",
  "admin.engines_idle_hint": "最後の利用から停止するまでの時間です。起動中の停止を避けるため {m} 分以上にしてください。",
  ...
  "admin.idle_hold_imagejob_row": "画像生成のジョブが実行中または待機中",
  ...
  "clean.subtitle": "溜まった停止中セッション・不要な worktree・マージ済みブランチ・削除済みセッションのキャッシュを点検して片付けます。",
  "clean.loading": "点検中…",
  ...
  "clean.stage1_confirm_body": "{parts}します。アーカイブしたセッションはアーカイブ一覧から、ごみ箱へ移した shell/ssm は掃除のごみ箱から戻せます。",
  ...
  "clean.stage2_confirm_body": "「安全」と判定された {count} 件を削除します。ブランチは削除前にごみ箱へ退避されます。作業コピーの中の停止中セッションはアーカイブへ（shell/ssm はごみ箱へ）移ります。worktree の削除は取り消せません。",
  ...
  "clean.action_delete_cache": "削除（元に戻せない）",
  ...
  "clean.purge_old": "{days} 日より古いものを完全に削除",
  "clean.purge_old_hint": "{days} 日より古いアーカイブ {count} 件（{size}）",
  ...
  "clean.reason.cache_no_store": "セッションの保存先が見つからないので、セッションのフォルダは判定しない（チャットの分だけが対象。保存先が戻れば点検できる。元に戻せない）",
  ...
  "clean.reason_badge.cache_orphan": "参照なし",
  ...
  "clean.reason_badge.cache_no_store": "保存先なし",
  "clean.reason_hint.cache_no_store": "セッションの保存先が見つからないため、セッションのフォルダは判定しません。チャットの分だけが対象です。削除は元に戻せません",
