...
export const en: Record<keyof typeof ja, string> = {
  ...
  "git.bb_token_hint_pr": " is optional — only for listing pull requests in the work item rail, not for clone or push.",
  ...
  "tenant.git_oauth_intro": "Decides which OAuth app the “Connect with OAuth” buttons use for your members (GitHub and Bitbucket under Connections › Git, Jira under Connections › Work items). The app is created in your own GitHub org / Bitbucket workspace / Atlassian account, so a tenant administrator registers it here. It takes effect the moment you save — there is no approval step.",
  ...
  "wi.load_failed": "Couldn't load work items",
  "wi.query_failed": "Couldn't fetch “{label}”",
  "wi.empty": "No matching work items",
  ...
  "tracker.intro": "Connections that feed the “Work items” rail on the left. GitHub issues and PRs reuse the Git connection (Settings › Git), so only Jira appears here. Credentials are stored encrypted inside the workspace and never reach the Control Plane.",
  ...
  "ops.jira_hint": "Connects the work item rail to Jira. Create an API token in your Atlassian account settings — read-only access is enough. The email and token are kept in this container's encrypted store and never reach the Control Plane. The connection is verified before it is saved.",
