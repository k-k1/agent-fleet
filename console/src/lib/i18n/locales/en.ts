...
export const en: Record<keyof typeof ja, string> = {
  ...
  "mirror.skills_btn": "Skills / commands (from .claude; typing \"/\" in the input opens this too)",
  "mirror.skills_loading": "Loading skills…",
  "mirror.skills_empty": "No skills/commands for this session (.claude/skills · .claude/commands)",
