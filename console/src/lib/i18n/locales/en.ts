...
export const en: Record<keyof typeof ja, string> = {
  ...
  "pmcp.copy_from_cell": "Copy \"{server}\" from {file} to another file",
  "pmcp.copy_title": "Copy \"{server}\" ({file}) to another file",
  "pmcp.copy_to": "Copy to",
  "pmcp.copy_as": "Name",
  "pmcp.on_conflict": "An entry with this name already exists",
  "pmcp.on_conflict_overwrite": "Overwrite",
  "pmcp.on_conflict_skip": "Skip",
  "pmcp.on_conflict_rename": "Add under a different name",
  "pmcp.dialect_label": "Placeholder dialect",
  "pmcp.dialect_translate": "Translate the dialect (recommended)",
  "pmcp.dialect_as_is": "Write as-is",
  "pmcp.dialect_expand": "Expand to the real value (not recommended)",
  "pmcp.dialect_none_hint": "{kind} does not expand placeholders. No conversion is available.",
  "pmcp.with_secrets": "Values",
  ...
  "pmcp.preview_title": "Preview (values masked)",
  "pmcp.preview_action": "Preview",
  "pmcp.apply_action": "Apply",
  "pmcp.applied": "Written to {file}",
  "pmcp.view_in_scm": "View changes",
  "pmcp.plan_stale": "This file changed elsewhere. Please preview again.",
  "pmcp.op_skipped_toast": "Skipped — an entry with that name already exists",
  ...
  "pmcp.diff_before": "Before",
  "pmcp.diff_after": "After",
