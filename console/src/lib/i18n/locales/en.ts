...
export const en: Record<keyof typeof ja, string> = {
  ...
  "ui.claude_full_model": "Full Claude model ID",
  "ui.claude_full_model_placeholder": "Full model ID (for example, claude-opus-4-8)",
  "ui.claude_full_model_hint": "Enter a full model ID to pin an older release. Claude Code checks availability when it starts.",
