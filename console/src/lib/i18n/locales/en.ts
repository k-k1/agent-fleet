...
export const en: Record<keyof typeof ja, string> = {
  ...
  "env.agent_update_label": "Update claude / opencode / codex / rtk to the latest on start",
  ...
  "admin.allow_self_update": "Allow members to update claude / opencode / codex / rtk themselves",
