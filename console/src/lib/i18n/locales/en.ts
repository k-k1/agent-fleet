...
export const en: Record<keyof typeof ja, string> = {
  ...
  "agents.kiro_install_desc": "The Kiro CLI is not installed in this workspace yet — a one-time install is required.",
  "agents.kiro_install": "Install the Kiro CLI",
  "agents.kiro_install_note": "Downloads about 855MB into your home volume (takes a few minutes).",
  "agents.kiro_installing": "Installing the Kiro CLI… (about 855MB, a few minutes). The sign-in screen appears automatically when it finishes.",
  "agents.kiro_install_error": "Install failed. Check your connection and try again.",
  "agents.kiro_install_failed": "Failed to start the Kiro CLI install: {msg}",
  ...
  "keys.kt.quickRepliesNote":
    "When on, chips above the composer suggest your frequent short replies (OK, proceed, commit, …) plus candidates tuned to the latest reply. Click to drop one into the input, or Ctrl/⌘/Alt-click to send immediately. Suggestions are learned from the short messages you send. Default on.",
  ...
  "mirror.suggest_hint": "Click to insert · Ctrl/⌘/Alt-click to send now",
