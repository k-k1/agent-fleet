...
export const en: Record<keyof typeof ja, string> = {
  ...
  "ops.cat_tracker_sub": "Feeds the “Work items” rail on the left (not an SRE-assistant integration). GitHub reuses the Git connection above.",
  "ops.cat_tracker": "Issue tracker (work items)",
