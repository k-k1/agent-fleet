...
export const en: Record<keyof typeof ja, string> = {
  ...
  "wi.bb_desc_reviewing": "Pull requests where you are a reviewer, in the repository you pick.",
  "wi.bb_desc_repo_open": "Every open pull request in the repository you pick.",
  "wi.bb_desc_authored": "Pull requests you opened, across the whole workspace. Bitbucket has no cross-repository search, so this is the only thing it can list per workspace.",
