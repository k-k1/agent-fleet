...
export const en: Record<keyof typeof ja, string> = {
  ...
  "agents.agy_usage_title": "Quota remaining",
  "agents.agy_usage_weekly": "weekly",
  "agents.agy_usage_5h": "5-hour limit",
  "agents.agy_usage_remaining": "{pct}% left",
  "agents.agy_usage_resets": "Resets: {when}",
  "agents.agy_usage_loading": "Fetching quota… (starting agy)",
  "agents.agy_usage_unavailable": "Could not fetch the quota",
  "agents.agy_usage_refresh": "Refresh quota",
