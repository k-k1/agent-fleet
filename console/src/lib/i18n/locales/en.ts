...
export const en: Record<keyof typeof ja, string> = {
  ...
  "mirror.suggest_hint": "Click to insert · Ctrl/⌘/Alt-click to send now (Tab from an empty input to reach the chips)",
