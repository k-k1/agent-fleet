...
export const admin: Record<keyof typeof jaAdmin, string> = {
  ...
  "admin.idle_hold_imagejob": "Held: image generation",
  ...
  "clean.stage1_confirm_body": "Will {parts}. Archived sessions can be restored from the archive browser (the shelf), and shell/ssm moved to the trash from the cleanup trash.",
  ...
  "clean.stage2_confirm_body": "Delete the {count} items graded safe. Branches are moved to the trash first. Stopped sessions in a deleted working copy move to the archive (shell/ssm to the trash). Deleting a worktree cannot be undone.",
  ...
  "clean.confirm_body": "Deleted sessions and branches are moved to the trash for recovery. Deleting a worktree moves its stopped sessions to the archive (shell/ssm to the trash). Deleting a worktree can't be undone (uncommitted/unpushed work is protected).",
  ...
  "clean.purge_old": "Delete permanently: older than {days} days",
  "clean.purge_old_hint": "{count} archive(s) older than {days} days ({size})",
  "clean.purge_old_title": "Permanently delete archives older than {days} days?",
  "clean.purge_old_body": "{count} archive(s) ({size}) can no longer be restored. The trash never empties on its own.",
  "clean.purge_old_done": "Permanently deleted {count} archive(s) ({size}).",
  "clean.purge_old_done_kept": "Permanently deleted {count} archive(s). Kept {kept} (a restore stopped part way, or no readable date).",
  ...
  "clean.reason.stopped": "Stopped (resumable). Archive it to clear the list once it's finished (left alone, it moves to the archive when the window is up)",
  ...
  "clean.reason.cache_no_store": "The session store is missing, so session folders are not judged (only chat folders are covered; survey again once the store is back; cannot be undone)",
  ...
  "clean.reason_hint.archived": "Never deleted automatically; delete to reclaim, recoverable",
  ...
  "clean.reason_badge.cache_no_store": "No session store",
  "clean.reason_hint.cache_no_store": "The session store is missing, so session folders are not judged; only chat folders are covered. Deleting cannot be undone",
