...
export const admin: Record<keyof typeof jaAdmin, string> = {
  ...
  "admin.catalog_parts": "Files and parts",
  "admin.catalog_parts_unknown": "No file keys are recorded for this model.",
  "admin.catalog_manual_s3": "Register an existing S3 file",
  ...
  "admin.catalog_vae_unreachable": "the VAE source could not be reached",
  ...
  "admin.catalog_attach": "Attach part",
  "admin.catalog_replace": "Replace",
  "admin.catalog_operation_title": "Add model file",
  "admin.catalog_act_new": "New model",
  "admin.catalog_act_attach": "Attach a part",
  "admin.catalog_act_replace": "Replace a part",
  ...
  "admin.catalog_destination": "Destination",
  "admin.catalog_pick_target": "Choose a registered model",
  "admin.catalog_pick_part": "Choose a file role",
  "admin.catalog_size_unknown": "Size not reported",
  "admin.catalog_reuse_present": "Existing file will be reused",
  "admin.catalog_with_vae": "Add the family VAE required by this checkpoint",
  "admin.catalog_vram_warning": "The file alone needs about {need} MiB; the selected card has {card} MiB. Continue anyway.",
  "admin.catalog_vram_warning_llm": "Weights and the KV cache need about {need} MiB at this context; the selected card has {card} MiB. Continue anyway.",
  ...
  "admin.catalog_resolving": "Checking the selected file…",
  "admin.catalog_need_target": "Choose the registered model to change.",
  "admin.catalog_need_part": "Choose the file role to change.",
  "admin.catalog_need_license": "Read and accept the source licence to continue.",
  "admin.catalog_need_vram": "Acknowledge the VRAM warning to continue.",
