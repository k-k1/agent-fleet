...
export const mirror: Record<keyof typeof jaMirror, string> = {
  ...
  "mirror.approval_asking": "The agent is asking to run a tool",
  "mirror.approval_protected": "protected write",
  ...
  "mirror.hsearch_label": "Search past inputs",
  "mirror.hsearch_failed": "No match",
  "mirror.hsearch_ph": "Search what you've sent (Ctrl+R)",
  "mirror.hsearch_hint": "Ctrl+R older · Ctrl+S newer · Enter to the input (no send) · Esc cancels",
  "mirror.hsearch_cancel": "Cancel the search and restore what you were typing",
  "mirror.hsearch_open": "Search past inputs (Ctrl+R)",
  ...
  "mirror.skills_more_cli": "Show {n} more bundled with the CLI",
  "mirror.skills_cli_desc.dataviz": "Chart and dashboard design guidance",
  "mirror.skills_cli_desc.update-config": "Change settings: hooks, permissions, environment variables (settings.json)",
  "mirror.skills_cli_desc.keybindings-help": "Customize or add keyboard shortcuts",
  "mirror.skills_cli_desc.code-review": "Review the diff for bugs and cleanups",
  "mirror.skills_cli_desc.simplify": "Clean up the changed code without changing behavior",
  "mirror.skills_cli_desc.fewer-permission-prompts": "Allowlist common read-only commands to reduce permission prompts",
  "mirror.skills_cli_desc.loop": "Repeat a prompt or command on an interval (e.g. /loop 5m /foo)",
  "mirror.skills_cli_desc.schedule": "Create and manage routines: cloud agents on a schedule",
  "mirror.skills_cli_desc.claude-api": "Reference for building and debugging apps that use the Claude API",
  "mirror.skills_cli_desc.workflow-authoring": "How to write a Workflow script (multi-agent orchestration)",
  "mirror.skills_cli_desc.run": "Launch this project's app to see your change working",
  "mirror.skills_cli_desc.run-skill-generator": "Create a skill that knows how to run this project's app",
  "mirror.skills_cli_desc.init": "Initialize a new CLAUDE.md",
  "mirror.skills_cli_desc.security-review": "Security review of the pending changes on the current branch",
  "mirror.skills_cli_desc.verify": "Verify that the change works as intended",
  "mirror.skills_cli_desc.debug": "Turn on debug logging and investigate problems",
  "mirror.skills_cli_desc.batch": "Plan a large change; background agents each open a PR",
  "mirror.skills_cli_desc.doctor": "Diagnose the Claude Code installation",
  "mirror.skills_cli_desc.deep-research": "Multi-step, in-depth research",
