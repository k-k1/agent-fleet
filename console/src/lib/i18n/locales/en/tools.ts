...
export const tools: Record<keyof typeof jaTools, string> = {
  ...
  "env.db_state_starting": "starting…",
  "env.db_state_running": "running",
  "env.db_state_stopped": "stopped",
  ...
  "machine.home_disk_fs": "whole filesystem home is on",
  ...
  "machine.disk_cache": "Cache (~/.cache/agent-fleet)",
  "machine.disk_part_generated": "Generated images",
  "machine.disk_part_thumbs": "Thumbnails",
  "machine.disk_part_pasted": "Pasted and attached files",
  "machine.disk_part_codex_view_image": "Images codex viewed",
  "machine.disk_part_memo_images": "Memo images",
  "machine.disk_part_other": "Other",
  "machine.disk_orphans": "of which, deleted sessions",
  ...
  "machine.disk_note":
    "Counts only what Agent Fleet itself stores (not working copies or tool caches). Generated images expire after 30 days and thumbnails after 14. The deleted sessions' share and the trash can be tidied up from Cleanup.",
