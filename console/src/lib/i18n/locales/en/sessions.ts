...
export const sessions: Record<keyof typeof jaSessions, string> = {
  ...
  "agent.launch_hint.muse": "Launch Muse Code",
  ...
  "sess.stop_after_turn_on": "Will stop when this turn ends",
  "sess.stop_after_turn_off": "Stop-after-turn cancelled",
  ...
  "sess.delete_body": "Move “{name}” to the trash. You can restore it from the cleanup trash.",
  "sess.cleanup_archive_n": "archive {count}",
  "sess.cleanup_delete_n": "move {count} shell/ssm to the trash",
  ...
  "sess.tidy_orphans_trash": "Shell/ssm go to the trash and can be restored from the cleanup trash.",
  ...
  "srow.stop_after_turn_on": "Stop when this turn ends",
  "srow.stop_after_turn_off": "Don't stop after this turn",
  "srow.stop_after_turn_badge": "Stops when the running turn ends (resumable)",
  ...
  "ovw.group_count": "{alive} running / {n} total",
  "ovw.waiting_for": "waiting {d}",
  ...
  "ovw.switch_to_fleetgraph": "Graph",
  "ovw.switch_to_fleetgraph_hint": "Switch to the fleet graph (Ctrl/⌘ for a new pane)",
  "ovw.collapse": "Collapse child sessions",
  "ovw.expand": "Expand child sessions",
