...
export const gallery: Record<keyof typeof jaGallery, string> = {
  ...
  "gallery.menu": "Card actions",
  "gallery.copy_path": "Copy the path",
  "gallery.copy_name": "Copy the file name",
  "gallery.copied_path": "Copied the path",
  "gallery.copied_name": "Copied the name",
  "gallery.rename": "Rename the file",
  "gallery.rename_prompt": "New file name",
  "gallery.rename_bad_name": "The name cannot contain a slash",
  "gallery.rename_failed": "Rename failed: {msg}",
  "gallery.delete": "Delete the file",
  "gallery.delete_title": "Delete the image",
  "gallery.delete_body": "Delete {name}. This cannot be undone.",
  "gallery.delete_failed": "Deletion failed: {msg}",
