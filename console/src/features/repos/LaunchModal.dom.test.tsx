...
// that can only fail. lcpp is now in repoLaunchKinds (stage 2's driver landed), so this modal
// really does render for it in practice, not just through the registry-driven `kinds` prop
