...
export function TtsReadButton({
  ...
  return (
    <button type="button" className={"ghost " + className} title="読み上げ" onClick={() => speakText(text, source)}>
