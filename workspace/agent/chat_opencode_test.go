...
func TestOpencodeChatConfigCarriesConv(t *testing.T) {
	...
	c := &chatConversation{ID: id, Tools: toolsAFWrite}
...
func TestOpencodeChatConfigReadGrantHasNoConv(t *testing.T) {
	t.Setenv("HOME", t.TempDir())
	c := &chatConversation{ID: "ce4f94b9-2854-44ee-8425-61859128d669", Tools: toolsAFRead}
	path := opencodeChatConfig(c)
	if path == "" {
...
func TestOpencodeChatConfigSkippedWithoutGrant(t *testing.T) {
	t.Setenv("HOME", t.TempDir())
	c := &chatConversation{ID: "ce4f94b9-2854-44ee-8425-61859128d669", Tools: toolsNone}
...
func TestOpencodeChatDirHasNoMCP(t *testing.T) {
	home := t.TempDir()
	t.Setenv("HOME", home)
	c := &chatConversation{ID: "ce4f94b9-2854-44ee-8425-61859128d669", Tools: toolsAFWrite}
...
func TestChatDeleteRemovesOpencodeConfig(t *testing.T) {
	t.Setenv("HOME", t.TempDir())
	const id = "ce4f94b9-2854-44ee-8425-61859128d669"
	path := opencodeChatConfig(&chatConversation{ID: id, Tools: toolsAFWrite})
	if path == "" {
		t.Fatal("設定が生成されない")
	}
