...
// 0644 if not. docs/log/56 §6: "do not use 0600 … keep an existing file's mode and create
// new ones at 0644" — unlike a user-scope config write, this file is checked out by
