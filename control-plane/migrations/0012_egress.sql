-- docs/20 M2: egress observation aggregation for the log-only forward proxy.
...
-- tenant column yet, see docs/20). Keep comments free of semicolons and quotes because
