...
--
-- Together with license_accepted_by / license_accepted_at (migration 0058) this makes the
...
-- model in" reads.
ALTER TABLE engine_models ADD COLUMN license_accepted_tenant TEXT NOT NULL DEFAULT '';
...
ALTER TABLE engine_models ADD COLUMN license_accepted_license TEXT NOT NULL DEFAULT '';
