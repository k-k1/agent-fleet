...
CREATE TABLE engine_ingest_jobs (
  ...
  bytes         BIGINT NOT NULL DEFAULT 0,  -- declared size, for the row and for "sync +N s"
...
ALTER TABLE engine_models ADD COLUMN IF NOT EXISTS license_accepted_by TEXT NOT NULL DEFAULT '';
ALTER TABLE engine_models ADD COLUMN IF NOT EXISTS license_accepted_at TEXT NOT NULL DEFAULT '';
...
-- not say out loud.
ALTER TABLE engine_models ADD COLUMN IF NOT EXISTS commercial_use TEXT NOT NULL DEFAULT '';
