-- Repair: create cloud_cost_role_daily on a database that never got migration pg 0041.
--
...
CREATE TABLE IF NOT EXISTS cloud_cost_role_daily (
  ...
  unblended  BIGINT  NOT NULL DEFAULT 0,
  amortized  BIGINT  NOT NULL DEFAULT 0,
