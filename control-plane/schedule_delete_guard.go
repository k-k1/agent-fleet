...
func scheduleGuardErr(ctx context.Context, st store.Store, membershipID, repoName, sessionName string) error {
...
func scheduleDeleteGuard(ctx context.Context, st store.Store, membershipID string, r *http.Request) error {
