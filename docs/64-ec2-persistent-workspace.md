...
0.13.1 を acrt へ適用したときの実測。**焼き直しは成功して golden も公開されたのに、種の
...
社内利用者が実運用している acrt で踏んだ。**箱を終了する経路がどこにも無い**ので、
...
`Ec2MaxSlots` から外れる**。acrt（6 人・同時 4）なら定常 4〜6 台 ＝ root $15〜23/月 で、
