...
### 64.27.6 実機に入れた（2026-08-17・af.lazmix.jp）
...
保留は実デプロイ（af.acrt.link）で実際に焼きを止めた。歯止めは設計どおり正しく効いていたのに、
...
[docs/72](72-cp-arch-and-availability.md) の CP マルチアーキ検証のついでに、lazmix の EC2 を
数えて見つけた。
