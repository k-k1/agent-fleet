...
- [43-kiro-agent-kind.md](43-kiro-agent-kind.md) — `kind=kiro`（Kiro CLI、旧 Amazon Q Developer CLI）を第8種別として Terminal+Managed 両対応で実装（✅ Track A/B/C/A2/D 実装済み・実 CLI E2E 通過。設計判断は [decisions/0026](decisions/0026-kiro-agent-kind.md)）
