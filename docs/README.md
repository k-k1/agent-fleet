...
- [44-markdown-code-editor.md](44-markdown-code-editor.md) — Console の File ペイン編集、Markdown 3モード、`/fs/file` 保存API、revision競合、AI提案フォーマット、外部変更の追従（◐ Phase 2（Text/コード編集 MVP）実装済み。Phase 3（Markdown編集）着手中、Phase 3.5（外部変更追従）は設計のみ。ADR は [decisions/0027](decisions/0027-markdown-code-editor.md)）
