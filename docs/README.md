...
- [38-scheduled-execution.md](38-scheduled-execution.md) — 定時実行（オペレーター cron 型・CP scheduler + wakeFirer + MCP + Console UI）（✅ v1 コア実装済み。設計判断は [decisions/0021](decisions/0021-scheduled-execution.md)）
