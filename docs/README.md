...
- [46-usage-accounting.md](46-usage-accounting.md) — 使用量アカウンティング（機能別トークン計測とグラフ化）: 補助 LLM 呼び出し（アシスタント/要約/タイトル/サジェスト）とセッション本体を同じ台帳で測る（◐ P0.5〜P2 実装済み・API/UI は未着手。実測記録を含む。設計判断は [decisions/0029](decisions/0029-usage-accounting.md)）
