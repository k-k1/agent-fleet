...
[English](0027-markdown-code-editor.md) | 日本語

- 状態: **採用・Phase 4 まで実装済み**（2026-07-28）
- 詳細契約: [docs/44-markdown-code-editor.md](../log/44-markdown-code-editor.md)
- 関連: [docs/build/02-console.md](../build/02-console.ja.md)（Console のペイン構成）/
  [docs/build/04-agent.md](../build/04-agent.ja.md)（fs の境界と denylist）/
  [docs/build/05-api.md](../build/05-api.ja.md)（API 中継の地図）/
  [decisions/0011](0011-console-rebuild.ja.md)（Console リビルド）
