...
[English](0035-session-report-v2-ledger.md) | 日本語
...
- 関連: [docs/30](../log/30-session-report.md)（v1 の設計と事故史 — 専用 ADR は無い）/
  [0030](0030-turn-abort-auto-resume.ja.md)（中断分類 — v2 の述語に吸収）/
  [0015](0015-agent-managed-driver.ja.md)（notify seam — v2 でヒント化）
