...
- 状態: 確定（P3-3）
- 関連: [history/p3-3-envelope-crypto](../history/p3-3-envelope-crypto.md) / [security §4.4](../reference/security.md#44-シークレット管理) / [ロードマップ §12.3](../roadmap.md#123-tos-と分離の留意自社ホスト前提)
