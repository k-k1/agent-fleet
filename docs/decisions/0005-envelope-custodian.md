...
- 状態: 確定（P3-3）
- 関連: [history/p3-3-envelope-crypto](../history/p3-3-envelope-crypto.md) / [dev/07 §7.6 シークレット管理と封筒暗号](../dev/07-security.md#76-シークレット管理と封筒暗号)（旧 security §4.4） / [ロードマップ §12.3](../roadmap.md#123-tos-と分離の留意自社ホスト前提)
...
セルフホスト製品（[0001](0001-self-host-vs-saas.md)）では「その社が鍵を握り、オフボードでクリーンに失効できる」
ことが要る。
