...
[English](0018-container-browser-pane.md) | 日本語
...
- 関連: [31-container-browser-pane.md](../log/31-container-browser-pane.md)（実装契約・段階計画）/
  ...
  [dev/05 §5.3](../build/05-api.ja.md)（既存 port preview）/
  [0007-opencode-web-via-pk-webui.md](0007-opencode-web-via-pk-webui.ja.md)（サブパス方式の既知限界）
