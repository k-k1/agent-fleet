...
[English](0063-document-preview.md) | 日本語

- 状態: **採用・P0（PDF）/ P1（Office の簡易プレビュー）実装済み**（2026-08-31）。
  設計と実測は [docs/82](../log/82-document-preview.md)。
- 関連: [0046-drawio-viewer.md](0046-drawio-viewer.ja.md)（同じ「バイナリをペインの中で読む」系。
  同梱物と `?url` の作法はこれに倣った） / [0027-markdown-code-editor.md](0027-markdown-code-editor.ja.md)
  （File ペインの面の構成）
