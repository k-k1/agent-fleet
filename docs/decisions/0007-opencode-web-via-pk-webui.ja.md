...
[English](0007-opencode-web-via-pk-webui.md) | 日本語
...
- 状態: **廃止（撤回, 2026-07）** — `temp/remove-opencode-web-opencode-web-ui` で
  ...
  以下は当時の設計記録として残す。
- 関連: [reference/preview.md](../build/05-api.ja.md)（同じプロキシ機構・WS 制約）/ [HANDOFF §opencode](../HANDOFF.md) / rtk トグル（[エージェント設定タブ](../HANDOFF.md)）の隣に並ぶ機能
