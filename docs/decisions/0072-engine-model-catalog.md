...
- Status: **P0, P1 and P4 implemented and verified on hardware (2026-09-08..09). Of P5, only
  ...
  as of 2026-09-10, not yet verified on hardware (see the Japanese edition's "P2 の実装"
  section — this English edition has not been fully re-synced with that write-up yet). P3 and
  the rest of P5 are not started.**
...
- **P2 — ComfyUI (ADR 0071's P2, moved forward to here). Implemented 2026-09-10, not yet
  verified on hardware** (see the Japanese edition's "P2 の実装" section for the full write-up;
  not yet re-synced into this English edition). The self-built image (pinned tag `v0.34.0`, no
  ...
  the screen is P5. **Definition of done (not yet verified on hardware): on one box, SDXL and
  klein 4B (or Z-Image-Turbo) alternate per request and return pictures with no service restart
  in between, and 1024px SDXL comes back in the 8-second range of ADR 0071 measurement 7.**
