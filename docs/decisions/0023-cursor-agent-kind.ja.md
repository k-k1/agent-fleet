...
[English](0023-cursor-agent-kind.md) | 日本語
...
- 関連: [0019](0019-copilot-agent-kind.ja.md)（copilot — 直近の種別追加・本件のテンプレ）、
  [0008](0008-antigravity-cli-agent-kind.ja.md)（agy — Terminal 専用 MVP の先例）、
