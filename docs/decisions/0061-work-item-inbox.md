...
🔴 **Correction (2026-09-11): the parenthesis above — "on GitHub too, PRs do not appear unless you
write `is:pr`" — is wrong.** `/search/issues` returns pull requests with no `is:pr` at all (measured:
