...
[English](0059-repo-import-jobs.md) | 日本語

- 状態: **採用・実装済み**（2026-08-26）。設計と経緯は [docs/78](../log/78-repo-import-jobs.md)。
- 関連: [0024-svn-checkout.md](0024-svn-checkout.ja.md)（SVN 取り込みの本体。本 ADR はその完了判定を差し替える） /
  [0055-idle-stop-and-carried-interactions.md](0055-idle-stop-and-carried-interactions.ja.md)（止めてよいかの判定材料に
  「取り込み中」を足す） / [0030-turn-abort-auto-resume.md](0030-turn-abort-auto-resume.ja.md)（長い処理を
  リクエストの寿命から外す、同型の先例）
