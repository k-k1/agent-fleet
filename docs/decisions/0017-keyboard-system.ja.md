...
[English](0017-keyboard-system.md) | 日本語
...
- 関連: [29-keyboard-system.md](../log/29-keyboard-system.md)（設計本体・実装マップ）/
  [0011-console-rebuild.md](0011-console-rebuild.ja.md)（この体系が載る Console 基盤）/
  [0016-i18n.md](0016-i18n.ja.md)（将来、コマンド文言を lib/i18n へ集約する接続先）
