...
> - **UI/契約/ADR 完了**: WsBar に OOM 表示（メモリタイル crit＋状態チップ warn、`32aec21`）、`docs/dev/05-api-contracts.md` に stats 契約追記、[decisions/0014](decisions/0014-agent-exit-recording.md) 起票。
