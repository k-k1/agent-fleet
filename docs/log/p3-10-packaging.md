...
> 🗄 **歴史的記録（初期プラン）— 実装は [docs/35 パッケージング](../log/35-packaging.md) で実施**。現状は [HANDOFF](../HANDOFF.md)、方針は [ロードマップ P3-10](../roadmap.md#p3-10-パッケージング--配布--アップグレード提供モデルの核) / [decisions/0001](../decisions/0001-self-host-vs-saas.md)。
