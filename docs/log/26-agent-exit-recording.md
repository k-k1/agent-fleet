...
> - **UI/契約/ADR 完了**: WsBar に OOM 表示（メモリタイル crit＋状態チップ warn、`258af54`）、`docs/build/05-api.ja.md` に stats 契約追記、[decisions/0014](../decisions/0014-agent-exit-recording.ja.md) 起票。
...
意思決定は ADR 化済み: [decisions/0014-agent-exit-recording.md](../decisions/0014-agent-exit-recording.ja.md)（実装で確定した §7 の各決定を記録）。
