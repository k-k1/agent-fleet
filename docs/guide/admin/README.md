...
| 稼働中の Workspace を強制停止する | メンバー詳細 → 操作 | [02-limits.md](02-limits.md) |
...
- **使用量** — 期間を区切って、メンバーごとの Workspace 稼働時間を見ます。CSV で書き出せます。→ [03-audit-usage.md](03-audit-usage.md)
...
| 事柄 | 担当 |
|------|------|
| メンバーの追加、セッション上限、Workspace の強制停止、監査・使用量の確認 | **あなた（tenant_admin）** |
...
3. **いま効いている上限を知る** — テナントカードの「上限 — Workspace / Session」を見ておきます。厳しすぎ／
