...
- ファイルツリーにフォーカスがあるとき: **↑ ↓ ← → / Enter** で移動・開閉、**Ctrl+↑ ↓** でフォルダ間移動、**Shift+↑ ↓** でビュアーをスクロール（[05 ファイル](05-files.ja.md)）。
...
[05 ファイル](05-files.ja.md)。なお端末の背景色は、ライトテーマにしても暗いままです。）
