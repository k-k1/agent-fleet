...
- **プレビュー** — ワークスペース内で立ち上げた Web サービスを確認する入口です。Console のペインに映す **ブラウザペイン**、別タブで開く **軽量プレビュー**、環境によっては起動ごとに発行される **プレビュー用サブドメイン**（ポートごとの URL）があります（[08 一歩進んだ使い方](08-advanced.ja.md)）。
